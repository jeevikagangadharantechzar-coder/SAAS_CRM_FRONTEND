  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="flex items-center space-x-2 text-xs font-semibold text-slate-400 dark:text-slate-500">
        ...
        <span>&gt;</span>
        <span className="text-slate-600 dark:text-slate-400">Create plan</span>
      </nav>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h2 className="text-slate-900 dark:text-white">Create Subscription Plan</h2>
          <p className="text-base text-slate-600 dark:text-slate-400">Add a new SaaS pricing tier and access limits.</p>
        </div>
      </div>
