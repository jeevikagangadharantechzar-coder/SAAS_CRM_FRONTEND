  ...
  const handleVoiceCommand = (text) => {
    ...
    if (command.includes('go to') || command.includes('open') || command.includes('navigate') || command.includes('show')) {
      ...
      const routes = {
        ...
        'rejected deals': { path: '/deals/rejected', name: 'Rejected Deals' },
        'leads': { path: '/leads', name: 'Leads' },
        'lead': { path: '/leads', name: 'Leads' },
        'rejected leads': { path: '/leads/rejected', name: 'Rejected Leads' },
        'create leads': { path: '/createleads', name: 'Create Leads' },
        'create lead': { path: '/createleads', name: 'Create Leads' },
        'create deal': { path: '/createDeal', name: 'Create Deal' },
        'create deals': { path: '/createDeal', name: 'Create Deal' },
        ...
        'send proposal': { path: '/proposal/sendproposal', name: 'Send Proposal' },
        'draft proposals': { path: '/proposal/drafts', name: 'Draft Proposals' },
        'drafts': { path: '/proposal/drafts', name: 'Drafts' },
        'calendar': { path: '/schedule', name: 'Calendar' },
        'schedule': { path: '/schedule', name: 'Schedule' },
        'activity': { path: '/list', name: 'Activities' },
        'activities': { path: '/list', name: 'Activities' },
        ...
        'team analytics': { path: '/team-analytics', name: 'Team Analytics' },
        ...
        'lead loss analysis': { path: '/leads/lead-loss-analysis', name: 'Lead Loss Analysis' },
        ...
        'create email': { path: '/create-email', name: 'Create Email' },
        'scheduled emails': { path: '/scheduled-emails', name: 'Scheduled Emails' },
        'email history': { path: '/email-history', name: 'Email History' },
        'trash': { path: '/trash', name: 'Trash' },
        'lead document': { path: '/lead-document', name: 'Lead Document' },
        'lead documents': { path: '/lead-document', name: 'Lead Documents' },
        'deal document': { path: '/deals-document', name: 'Deal Document' },
        'deal documents': { path: '/deals-document', name: 'Deal Documents' },
        'device requests': { path: '/device-requests', name: 'Device Requests' },
        'live locations': { path: '/live-locations', name: 'Live Locations' },
        'email chat': { path: '/emailchat', name: 'Email Chat' },
        'settings': { path: '/settings', name: 'Settings' },
        'notifications': { path: '/dashboard/notifications', name: 'Notifications' },
        'support': { path: '/support', name: 'Support' },
        'messages': { path: '/messages', name: 'Messages' },
        'task management': { path: '/task-management', name: 'Task Management' },
        'assigned tasks': { path: '/assigned-tasks', name: 'Assigned Tasks' },
        'target management': { path: '/target-management', name: 'Target Management' },
        'targets': { path: '/target-management', name: 'Targets' },
        'my targets': { path: '/my-targets', name: 'My Targets' },
        'meetings': { path: '/meetings', name: 'Meetings' },
        'google integration': { path: '/settings/google-integration', name: 'Google Integration' },
        'integrations': { path: '/integrations', name: 'Integrations' },
        'whatsapp': { path: '/whatsapp', name: 'WhatsApp' },
        'instagram': { path: '/instagram', name: 'Instagram' },
        'facebook': { path: '/facebook', name: 'Facebook' }
      };
