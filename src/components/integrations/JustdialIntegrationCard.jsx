...
import { Copy, CheckCircle, AlertCircle, PhoneCall } from "react-feather";
import { toast } from "react-toastify";

export default function JustdialIntegrationCard() {
  ...
  const webhookUrl = slug 
    ? `${baseUrl}/${slug}/api/justdial/webhook`
    : `${baseUrl}/api/justdial/webhook`;
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
      ...
      <div className="flex items-center gap-4 p-5 border-b border-gray-100">
        ...
        <div>
          <h2 className="font-semibold text-gray-800 text-lg">Justdial Lead Integration</h2>
          <p className="text-gray-500 text-sm">
            Capture incoming enquiries from Justdial directly into your CRM.
          </p>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="mt-6 border-t border-gray-100 pt-5">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600">
            ...
            <li>Contact your Justdial Account Manager or login to your Justdial Vendor Portal.</li>
      ...
      <div className="px-5 py-3 bg-blue-50 border-t border-blue-100 flex items-start gap-2">
        ...
        <p className="text-xs text-blue-700">
          This is a zero-cost integration. Justdial pushes the leads directly to your CRM without requiring premium API access.
        </p>
      </div>
    </div>
  );
