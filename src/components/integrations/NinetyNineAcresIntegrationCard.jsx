...
import { Copy, CheckCircle, AlertCircle, Home } from "react-feather";
import { toast } from "react-toastify";

export default function NinetyNineAcresIntegrationCard() {
  ...
  const webhookUrl = slug 
    ? `${baseUrl}/${slug}/api/99acres/webhook`
    : `${baseUrl}/api/99acres/webhook`;
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
      ...
      <div className="flex items-center gap-4 p-5 border-b border-gray-100">
        ...
        <div>
          <h2 className="font-semibold text-gray-800 text-lg">99acres Lead Integration</h2>
          <p className="text-gray-500 text-sm">
            Capture incoming enquiries from 99acres directly into your CRM.
          </p>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="mt-6 border-t border-gray-100 pt-5">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600">
            ...
            <li>Contact your 99acres Account Manager.</li>
      ...
      <div className="px-5 py-3 bg-blue-50 border-t border-blue-100 flex items-start gap-2">
        ...
        <p className="text-xs text-blue-700">
          This is a zero-cost integration. 99acres pushes the leads directly to your CRM without requiring premium API access.
        </p>
      </div>
    </div>
  );
