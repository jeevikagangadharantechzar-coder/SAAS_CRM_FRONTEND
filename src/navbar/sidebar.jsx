  ...
  return (
    ...
    >
      ...
      <nav className={`flex flex-col gap-2.5 ${isOpen ? "px-1.5" : "px-0.5 items-center"}`}>
        ...
        {isAdmin && hasPlanFeature("integration_whatsapp") && (
          <SidebarItem
            to="whatsapp"
            icon={<WhatsAppIcon />}
            label="WhatsApp"
        ...
        {/* Instagram Inbox — Admin only */}
        {isAdmin && hasPlanFeature("integration_instagram") && (
          <SidebarItem
            to="instagram"
            icon={<InstagramIcon />}
            label="Instagram"
        ...
        {/* Facebook Inbox — Admin only */}
        {isAdmin && hasPlanFeature("integration_facebook") && (
          <SidebarItem
            to="facebook"
